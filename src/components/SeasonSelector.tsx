...
export default function SeasonSelector({ selectedSeason, onSelectSeason, seasons = SEASONS_LIST, children }: SeasonSelectorProps) {
  ...
  return (
    <div 
      ...
      className="flex flex-col lg:flex-row items-center gap-6 py-4 px-6 bg-[#fcfcfc] border-b border-[#f0f0f0] w-full select-none"
    >
