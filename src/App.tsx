  ...
  return (
    <div id="app-root" className="min-h-screen bg-[#fafafa] flex text-black antialiased font-sans flex-col md:flex-row">
      ...
      <div className="flex-1 flex flex-col md:pl-16 min-w-0" id="main-content-lane">
        ...
        <footer className="py-6 px-6 md:px-12 border-t border-gray-150 text-center text-xs text-gray-400 font-mono mt-auto flex flex-col sm:flex-row items-center justify-between gap-4">
          <div>DeepInk Team - Cebric Beta</div>
          <div className="flex items-center gap-3">
            <span className="text-[11px] text-gray-400 uppercase tracking-wider font-semibold">Join Paddock:</span>
            <a 
              href="https://t.me/CEBRICF1" 
              target="_blank" 
              rel="noreferrer noopener" 
              title="Join Telegram Community"
              className="p-1.5 hover:text-[#EF1A2D] hover:bg-neutral-100 rounded-lg transition-colors text-gray-500 border border-gray-150 bg-white shadow-xs"
            >
